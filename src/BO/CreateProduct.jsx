...
import { createObjProduct, createProductDataFetch} from "../constants/dataFetchs";
...
const CreateProduct = () =>{
    ...
    const handleClick = async () => { 
      ...
      if(result?.error) return console.log(`Existio un error en CreateProduct: ${result.error}`)
