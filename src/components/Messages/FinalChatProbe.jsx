...
const FinalChatProbe = ({
    ...
    useEffect(() => {
        ...
        const loadMessageInitial = async () => {
            try {
                ...
                console.error('Hubo un error al intentar cargar los mensajes del usuario', error)
                return null;
            }
        }
    ...
    useEffect(() => {
        ...
        if (!verify) return console.error('El tipo de chat no es valido para los iconos')
