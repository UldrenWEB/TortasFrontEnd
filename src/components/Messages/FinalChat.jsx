...
const FinalChat = ({ userData, typeChat }) => {
    ...
    //             //     }
    //             // })
    //             // if (!messages || messages.error) return console.error(`Hubo un error obtner los mensajes del usuario`)
    ...
    //             // if (!rooms || rooms.error) return console.error('Hubo un error al intentar obtener las rutas')
    //             // let array = []
    //             // rooms.forEach(obj => {
    ...
    //             if (!socketClient) return console.error('Huno un error al crear el socket del client')
    ...
    //             if (!joinNamespace || joinNamespace.error || joinRoom.error || !joinRoom) return console.error('Hubo un error al unirse al nameSpace o al room')
    ...
    //     if (objChat[typeChat] === 'namespace') return setTypeEvent('broadcast message')
    //     if (objChat['zones'].includes(typeChat)) return setTypeEvent('room message')
    ...
    console.log('Aqui objChat', objChat)
    return (
        <div>
            <Chat
                typeChat={typeChat}
